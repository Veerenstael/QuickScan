...
# ===== Stoplicht-overlay =====
# Coördinaten zijn "top-center" (x,y ∈ 0..1)
    ...
    try:
        ...
        for sect, rows in grouped.items():
            ...
            for vraag,antwoord,cust in rows:
                if cust!="-":
                    try: ci=int(cust); cust_scores.append(ci)
                    except Exception: pass
        ...
        if radar_sections:
            ...
            try:
                ...
                pdf.section_title("Gemiddelde score per onderwerp (klant)"); pdf.image(img_path, w=180)
