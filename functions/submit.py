...
VERSION = "QS-2025-10-09-Netlify-Python"
...
def build_stoplight_overlay(section_labels, section_scores, out_path="/tmp/stoplicht.png"):
    base_path = os.path.join(os.path.dirname(__file__), "afbeelding.png")
    if not os.path.exists(base_path):
        print(f"afbeelding.png niet gevonden op {base_path}")
        return None
